<template>
	<div
		...
		class="absolute w-full h-full z-50 top-0 overflow-hidden bg-white/5 backdrop-blur-md"
	>
		<Transition
		...
		>
			<div
				v-if="show"
				ref="sheetBody"
				class="flex flex-col space-y-6 rounded-t-3xl bg-slate-900 mt-32 pt-8 px-6 h-[99%]"
