...
<template>
	<ul class="flex flex-col space-y-4 mt-3 mb-8">
		...
		>
			<button
				class="flex items-center w-full space-x-2 outline-none rounded-md py-2.5 px-3 dark:text-slate-400 text-gray-600 transition duration-150 ease-in"
...
button {
	...
	dark:hover:bg-slate-400/20 hover:bg-white/60
	border-t dark:border-t-slate-700 border-t-gray-200
